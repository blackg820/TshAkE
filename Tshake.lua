...
if text == (database:get(bot_id.."Tshake:Name:Bot") or " بيروت") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or " بيروت")
local namebot = {
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or " بيروت")
